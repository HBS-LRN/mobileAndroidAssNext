...
class EventParticipantsViewModelFactory(private val application: Application) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(EventParticipantsViewModel::class.java)) {
            @Suppress("UNCHECKED_CAST")
            return EventParticipantsViewModel(application) as T
        }
